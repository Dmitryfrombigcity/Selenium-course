...
stepic = 'https://stepik.org/lesson/732083/step/8?unit=733616'
...
with webdriver.Chrome(options=options) as driver:
    ...
    driver.get(url)
    if wait.until(ec.element_located_to_be_selected(('id', 'myCheckbox'))):
        wait.until(ec.element_to_be_clickable(('xpath', '//div[@id="main_container"]/button'))).click()
